...
class ChildProfile
  ...
  @@child_dob = {}
  @@children = []
  attr_accessor :id, :name, :dob, :gender, :guardian_1_name, :guardian_1_email, :guardian_1_address,
                :guardian_1_phone, :age, :guardian_2_name, :guardian_2_email, :guardian_2_address, :guardian_2_phone
